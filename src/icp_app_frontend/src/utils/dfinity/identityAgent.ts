import { Agent, ApiQueryResponse, CallOptions, HttpAgent, Identity, IdentityInvalidError, QueryFields, ReadStateOptions, ReadStateResponse, SubmitResponse } from "@dfinity/agent";
